         ...
         http
             ...
             .authorizeHttpRequests(requests -> {
                 requests
                         ...
                         .requestMatchers(HttpMethod.GET, String.format("%s/categories**", apiPrefix)).hasAnyRole(Role.USER, Role.ADMIN) // category
                         ...
                         .requestMatchers(HttpMethod.GET, String.format("%s/products?**", apiPrefix)).hasAnyRole(Role.USER, Role.ADMIN)  // Product
                         ...
                         .requestMatchers(HttpMethod.POST, String.format("%s/orders/**", apiPrefix)).hasRole(Role.USER)     // Order
                         ...
                         .requestMatchers(HttpMethod.POST, String.format("%s/order_details/**", apiPrefix)).hasRole(Role.USER)  // Order_detail
